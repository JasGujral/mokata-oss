...
SETTINGS: Tuple[Setting, ...] = (
    ...
    Setting("settings.review.verdict_max_age_hours", "review.verdict_max_age_hours",
            "hours (e.g. 24) | 0 | off", "24",
            "how old a review PASS may be and still satisfy the ship gate; 0/off disables it"),
