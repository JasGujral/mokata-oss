...
# Make the package importable whether run from the repo or an installed location. Stage 3
# moved this file to <root>/src/mokata/hooks/, so <root>/src (the parent of the `mokata`
# package) is two directories up from here.
