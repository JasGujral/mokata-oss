...
> **mokata Agent Skill.** This is mokata's `mcp` capability, surfaced so Claude can engage it
> automatically when the moment fits. It runs the SAME protocol as the `/mokata:mcp` command,
